...
class PinView : androidx.appcompat.widget.AppCompatEditText {
    ...
    private var isMpin: Boolean = false
    private val DOT = '\u2022'
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        this.transformationMethod = if (isMpin) PasswordTransformationMethod() else HideReturnsTransformationMethod.getInstance()
    }
    ...
    fun setMpinMode(states: Boolean) {
        this.isMpin = states
